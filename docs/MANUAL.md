...
- **`ULTIMATE_GORILLA_KERNEL.sh`**: Master build and orchestration script for local recompilation, network tuning, and telemetry excision.
...
5.  **Total Hybridization**: Combines GNU IceCat Defense-in-Depth with Gorilla Excision.
